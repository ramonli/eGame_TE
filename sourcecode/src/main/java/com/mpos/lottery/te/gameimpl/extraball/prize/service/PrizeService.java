...
public interface PrizeService extends ReversalOrCancelStrategy {
     ...
     * 'active', 'result entered' etc) should be regarded as 'return'.
     * 
     * @param respCtx
     ...
     */
    Prize enquiry(Context<?> respCtx, BaseTicket clientTicket) throws ApplicationException;

    /**
     * This operation will pay for winning ticket. One ticket can be paid only once, and operator will collect the
     * winning ticket after payout. To a multiple-draw ticket, there will be multiple tickets records, also one ticket
     * record will has one corresponding 'PAYOUT' record if this ticket record wines a prize(even return is a payout).
     * <p>
     ...
     * <tr>
     * <td>TicketID</td>
     * <td>LottoTicket SerialNO</td>
     * <td>LottoTicket Status</td>
     ...
     * </tr>
     * </table>
     * <h1>Print New LottoTicket Mode</h1>
     ...
     * </table>
     * <p>
     * Then a 'confrim refund' request should be issued by client, when got this request, TE can be very sure that
     ...
     * </tr>
     * </table>
     * And one payout entity will be generated:
     * <table border="1">
     * <tr>
     * <td>ID</td>
     * <td>LottoTicket SN</td>
     ...
     * </tr>
     * </table>
     * And 3 payout entities will be generated:
     * <table border="1">
     * <tr>
     * <td>ID</td>
     * <td>LottoTicket SN</td>
     ...
     *            The context of transaction.
     * @param clientTicket
     *            The payout request. The following components of LottoTicket argument must not be null: serialNo,PIN(if
     *            the backend ask to verify PIN), inputChannel.
     * @return the payout result.
     * @throws ApplicationException
     *             when encounter any business exception.
     */
    Prize payout(Context<?> respCtx, BaseTicket clientTicket) throws ApplicationException;

    /**
     * Why we need payout confirmation??? The main goal of this transaction is to guarantee that all sale tickets will
     * join winning analysis. If customer buy a multiple-draw ticket, and this ticket win a prize. when customer go to
     ...
     * <ul>
     * <li>A: client has printed new ticket, and paid cash to customer</li>
     * <li>B: client didn't print new ticket, returned old physical ticket to customer.</li>
     * </ul>
     ...
     * situation A, customer has got prize and new printed ticket, he/she just thought the payout has finished
     * successfully. Later he/she will maybe come back to claim prize with new printed tickets. So in this case, TE
     * should think old tickets as company absorption. To situation B, customer didn't got prize, he/she will get back
     * the old tickets, so TE should think new printed tickets as company absorption.
     * 
