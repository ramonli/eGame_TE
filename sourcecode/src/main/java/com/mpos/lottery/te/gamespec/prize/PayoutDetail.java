...
@Entity
@Table(name = "PAYOUT_DETAIL")
public class PayoutDetail implements java.io.Serializable {
    ...
    /**
     * Refer to {@link com.mpos.lottery.te.gamespec.prize.PrizeLevel#PRIZE_TYPE_CASH} and
     * {@link com.mpos.lottery.te.gamespec.prize.PrizeLevel#PRIZE_TYPE_OBJECT}
     */
