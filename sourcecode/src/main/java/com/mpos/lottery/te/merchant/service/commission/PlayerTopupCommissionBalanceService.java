...
@Service("playerTopupCommissionBalanceService")
public class PlayerTopupCommissionBalanceService extends AbstractCommissionBalanceService {
    ...
    protected List<CommissionUnit> determineCommUnits(Transaction trans) throws ApplicationException {
        ...
        CommissionUnit commUnit = new CommissionUnit(null, operator.getTopupReat(), trans.getTotalAmount(),
