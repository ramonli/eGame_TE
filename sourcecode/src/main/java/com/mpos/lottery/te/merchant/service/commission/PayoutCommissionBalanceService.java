...
@Service("payoutCommissionBalanceService")
public class PayoutCommissionBalanceService extends AbstractCommissionBalanceService {
    ...
    protected List<CommissionUnit> determineCommUnits(Transaction trans) throws ApplicationException {
        ...
        CommissionUnit commUnit = new CommissionUnit(trans.getGameId(), operatorComm.getPayoutRate(),
