...
public class DestinationActivityReportDaoImpl extends BaseJpaDao implements ActivityReportDao {
    private Log logger = LogFactory.getLog(DestinationActivityReportDaoImpl.class);
    ...
    public List<DailyActivityReport> findActivityReport(String operatorId, Date startTime, Date endTime) {
        ...
        sql.append(" select a.TRANSACTION_TYPE, ")
                ...
                // cashout withdraw(365),? Top up by voucher(447)
        ...
        for (Object row : rows) {
            ...
            int transType = Integer.parseInt("" + Constants.DESTINATION_TRANSTYPE_PREFIX
                    + ((BigDecimal) columns[0]).intValue());
