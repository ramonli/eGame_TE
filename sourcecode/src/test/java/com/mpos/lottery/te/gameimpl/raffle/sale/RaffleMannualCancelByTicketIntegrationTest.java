...
public class RaffleMannualCancelByTicketIntegrationTest extends BaseServletIntegrationTest {
    ...
    public void testCancel_OK() throws Exception {
        ...
        // assert ticket
        List<RaffleTicket> dbTickets = this.getTicketDao().findBySerialNo(RaffleTicket.class, ticket.getSerialNo(),
                false);
        for (RaffleTicket dbTicket : dbTickets)
    ...
    public void testCancel_GameInstance_Disable() throws Exception {
        ...
        this.jdbcTemplate.update("update RA_GAME_INSTANCE set IS_SUSPEND_MANUAL_CANCEL=1");
