...
public class UnionGameInstanceServiceIntegrationTest extends BaseTransactionalIntegrationTest {
    @Resource(name = "unionGameInstanceService")
    ...
    public void testEnquiryByGameAndDrawNO_Stopped_Channel() throws Exception {
        ...
        try {
            this.getGameInstanceService().enquirySaleReady(respContext, "GAME-UNION-111", "20090408", 1);
    ...
    public void testEnquiryByGameAndDrawNO_SuspendGameInstance() throws Exception {
        this.jdbcTemplate.update("update UN_GAME_INSTANCE set IS_SUSPEND_SALE=1 where GAME_INSTANCE_ID='GII-113'");
    ...
    public void testEnquiryByGameAndDrawNO_InactiveGameInstance() throws Exception {
        this.jdbcTemplate.update("update UN_GAME_INSTANCE set STATUS=" + BaseGameInstance.STATE_PAYOUT_STARTED
