...
public class UnionTicketCancellationIntegrationTest extends BaseServletIntegrationTest {
    ...
    public void testCancelByTicket_OK() throws Exception {
        ...
        UnionTicket respTicket = (UnionTicket) saleRespCtx.getModel();

        this.entityManager.flush();
        this.entityManager.clear();

        // 2. cancel by ticket
        UnionTicket cancelTicket = new UnionTicket();
    ...
    private void triggerCancelDecline() {
        this.jdbcTemplate
                .update("update un_game_instance set game_freezing_time=sysdate-30/(24*60) where GAME_INSTANCE_ID='GII-113'");
    }
