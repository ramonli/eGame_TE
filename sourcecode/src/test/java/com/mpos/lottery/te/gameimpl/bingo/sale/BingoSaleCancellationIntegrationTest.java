...
public class BingoSaleCancellationIntegrationTest extends BaseServletIntegrationTest {
    ...
    @Test
    public void testCancelByTrans_SingleDraw_PlayerPickNumber_OK() throws Exception {
        printMethod();
        BingoTicket ticket = BingoDomainMocker.mockTicket();
    ...
    @Test
    public void testCancelByTicket_SingleDraw_SystemPickNumber_OK() throws Exception {
        printMethod();
        BingoTicket ticket = BingoDomainMocker.mockTicket();
    ...
    @Test
    public void testCancelByTrans_SingleDraw_SystemPickNumber_OK() throws Exception {
        printMethod();
        BingoTicket ticket = BingoDomainMocker.mockTicket();
        ticket.getEntries().clear();
