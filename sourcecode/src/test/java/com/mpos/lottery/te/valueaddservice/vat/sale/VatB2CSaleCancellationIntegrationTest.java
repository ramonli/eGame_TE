...
public class VatB2CSaleCancellationIntegrationTest extends BaseServletIntegrationTest {
    ...
    public void test_Cancel_RaffleSale_SingleBet_OK() throws Exception {
        ...
        // 2. make cancellation
        Transaction transDto = new Transaction();
        transDto.setDeviceId(saleReqCtx.getTerminalId());
        transDto.setTraceMessageId(saleReqCtx.getTraceMessageId());
        Context cancelReqCtx = this.getDefaultContext(TransactionType.CANCEL_BY_TRANSACTION.getRequestType(), transDto);
